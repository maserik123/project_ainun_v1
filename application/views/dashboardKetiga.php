        ...
        <div class="col-sm-12">
            <div class="page-header float-center">
                <div class="page-title ">
                    ...
                    <br>
                    <div class="col-md-12">
                        <small>Representasi Faktor Penyebab Perceraian Per-Kecamatan <?php echo !empty($getKecamatanById[0]->kecamatan) ? $getKecamatanById[0]->kecamatan : ''; ?> Tahun <?php echo $thn; ?>.</small>
                    </div>
                </div>
            </div>
            <div class="card-body">

                <div id="detail_penyebab" style="height: 400px;">
                </div>
            </div>
        </div>
