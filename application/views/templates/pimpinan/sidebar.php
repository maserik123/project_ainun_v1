...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="./"><h6>Pengadilan Agama Dashboard</h6>
            <a class="navbar-brand hidden" href="./"><h4>PD</h4>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-user-circle"></i><a href="<?php echo site_url('pimpinan/C_grafik_perkara/index') ?>">Faktor Perkara</a></li>
                        <li><i class="fa fa-map"></i><a href="ui-tabs.html">Pesebaran Kasus</a></li>
                    </ul>
                </li>
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    ...
                    <div class="user-menu dropdown-menu">
                        ...
                        <a class="nav-link" href="<?php echo base_url() ?>index.php/pimpinan/dashboard/logout" ><i class="fa fa-power-off"></i> Logout</a>
                    </div>
                </div>
