            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-user-circle"></i><a href="ui-buttons.html">Faktor Perkara</a></li>
                        <li><i class="fa fa-user-circle"></i><a href="ui-badges.html">Faktor Penyebab</a></li>
            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    ...
                    <div class="user-menu dropdown-menu">
                        ...
                        <a class="nav-link" href="<?php echo base_url() ?>index.php/admin/dashboard/logout" ><i class="fa fa-power-off"></i> Logout</a>
                    </div>
                </div>
